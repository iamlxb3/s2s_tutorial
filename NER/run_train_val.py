...
from ner_exp_config import experiments
...
def main():
    ...
    cfg.optimizer = optim.Adam(list(encoder.parameters()), lr=cfg.lr)
    ...
    epoches_train(cfg, train_loader, val_loader, encoder, epoch_recorder, cfg.encoder_path)
    print('Training done!')
    #
