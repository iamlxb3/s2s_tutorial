...
if __name__ == '__main__':
    ...
    train_generator = torch_val_gen(train_x_paths, y_csv_path, index_name='index')
    val_generator = torch_val_gen(val_x_paths, y_csv_path, index_name='index')
