    ...
    for epoch, epoch_index in enumerate(range(cfg.epoches)):
        ...
        for batch_index, (batch_x, batch_y, uid) in enumerate(train_loader):
            ...
            loss = train_1_batch_basic_rnn(batch_x, batch_y, encoder, decoder,
                                           ...
                                           target_EOS_index=cfg.target_EOS_token,
                                           target_pad_token=cfg.target_pad_token, device=cfg.device)
        ...
        for X_val, Y_val, uid in val_loader:
            ...
            loss = eval_on_val(encoder, decoder, X_val, Y_val, cfg.device, cfg.target_SOS_token, cfg.target_pad_token,
